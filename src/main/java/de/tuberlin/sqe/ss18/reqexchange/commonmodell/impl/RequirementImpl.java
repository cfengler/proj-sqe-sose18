 ...
 * </p>
 * <ul>
 *   <li>{@link RequirementImpl#getPropertySets <em>Property Sets</em>}</li>
 *   <li>{@link RequirementImpl#getRelations <em>Relations</em>}</li>
 *   <li>{@link RequirementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementImpl extends IdentifiableImpl implements Requirement {
	...
	protected EClass eStaticClass() {
		return CommonmodellPackage.Literals.REQUIREMENT;
	}
	...
	public EList<PropertySet> getPropertySets() {
		if (propertySets == null) {
			propertySets = new EObjectResolvingEList<PropertySet>(PropertySet.class, this,
					CommonmodellPackage.REQUIREMENT__PROPERTY_SETS);
		}
		return propertySets;
	}
	...
	public EList<Relation> getRelations() {
		if (relations == null) {
			relations = new EObjectWithInverseResolvingEList.ManyInverse<Relation>(Relation.class, this,
					CommonmodellPackage.REQUIREMENT__RELATIONS, CommonmodellPackage.RELATION__REQUIREMENTS);
		}
		return relations;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonmodellPackage.REQUIREMENT__NAME, oldName,
					name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CommonmodellPackage.REQUIREMENT__RELATIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CommonmodellPackage.REQUIREMENT__PROPERTY_SETS:
			return getPropertySets();
		case CommonmodellPackage.REQUIREMENT__RELATIONS:
			return getRelations();
		case CommonmodellPackage.REQUIREMENT__NAME:
			return getName();
		}
