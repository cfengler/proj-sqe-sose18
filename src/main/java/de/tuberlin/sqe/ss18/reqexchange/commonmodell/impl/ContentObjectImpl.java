 ...
 * </p>
 * <ul>
 *   <li>{@link ContentObjectImpl#getPropertys <em>Propertys</em>}</li>
 *   <li>{@link ContentObjectImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContentObjectImpl extends IdentifiableImpl implements ContentObject {
	...
	protected EClass eStaticClass() {
		return CommonmodellPackage.Literals.CONTENT_OBJECT;
	}
	...
	public EList<Property> getPropertys() {
		if (propertys == null) {
			propertys = new EObjectResolvingEList<Property>(Property.class, this,
					CommonmodellPackage.CONTENT_OBJECT__PROPERTYS);
		}
		return propertys;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonmodellPackage.CONTENT_OBJECT__NAME, oldName,
					name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CommonmodellPackage.CONTENT_OBJECT__PROPERTYS:
			return getPropertys();
		case CommonmodellPackage.CONTENT_OBJECT__NAME:
			return getName();
		}
