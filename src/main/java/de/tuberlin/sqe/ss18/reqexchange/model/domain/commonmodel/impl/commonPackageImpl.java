...
import de.tuberlin.sqe.ss18.reqexchange.model.domain.commonmodel.Identifiable;
...
import de.tuberlin.sqe.ss18.reqexchange.model.domain.commonmodel.commonFactory;
...
public class commonPackageImpl extends EPackageImpl implements commonPackage {
	 ...
	 * <!-- end-user-doc -->
	 * @see Registry
	 * @see de.tuberlin.sqe.ss18.reqexchange.model.domain.commonmodel.commonPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static commonPackage init() {
		if (isInited)
			return (commonPackage) Registry.INSTANCE.getEPackage(commonPackage.eNS_URI);

		// Obtain or create and register package
		commonPackageImpl thecommonPackage = (commonPackageImpl) (Registry.INSTANCE
				.get(eNS_URI) instanceof commonPackageImpl ? Registry.INSTANCE.get(eNS_URI)
		...
		Registry.INSTANCE.put(commonPackage.eNS_URI, thecommonPackage);
