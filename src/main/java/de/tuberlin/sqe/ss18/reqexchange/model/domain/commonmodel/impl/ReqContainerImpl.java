 ...
 * </p>
 * <ul>
 *   <li>{@link de.tuberlin.sqe.ss18.reqexchange.model.domain.commonmodel.impl.ReqContainerImpl#getReqContainerChilds <em>Req Container Childs</em>}</li>
 *   <li>{@link de.tuberlin.sqe.ss18.reqexchange.model.domain.commonmodel.impl.ReqContainerImpl#getRequirements <em>Requirements</em>}</li>
 *   <li>{@link de.tuberlin.sqe.ss18.reqexchange.model.domain.commonmodel.impl.ReqContainerImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReqContainerImpl extends IdentifiableImpl implements ReqContainer {
	...
	protected EClass eStaticClass() {
		return commonPackage.Literals.REQ_CONTAINER;
	}
	...
	public EList<ReqContainer> getReqContainerChilds() {
		if (reqContainerChilds == null) {
			reqContainerChilds = new EObjectResolvingEList<ReqContainer>(ReqContainer.class, this,
					commonPackage.REQ_CONTAINER__REQ_CONTAINER_CHILDS);
		}
	...
	public EList<Requirement> getRequirements() {
		if (requirements == null) {
			requirements = new EObjectResolvingEList<Requirement>(Requirement.class, this,
					commonPackage.REQ_CONTAINER__REQUIREMENTS);
		}
		return requirements;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, commonPackage.REQ_CONTAINER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case commonPackage.REQ_CONTAINER__REQ_CONTAINER_CHILDS:
			return getReqContainerChilds();
		case commonPackage.REQ_CONTAINER__REQUIREMENTS:
			return getRequirements();
		case commonPackage.REQ_CONTAINER__NAME:
			return getName();
		}
