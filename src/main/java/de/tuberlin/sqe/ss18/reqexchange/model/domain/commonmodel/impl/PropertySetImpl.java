 ...
 * </p>
 * <ul>
 *   <li>{@link de.tuberlin.sqe.ss18.reqexchange.model.domain.commonmodel.impl.PropertySetImpl#getPropertys <em>Propertys</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertySetImpl extends IdentifiableImpl implements PropertySet {
	...
	protected EClass eStaticClass() {
		return commonPackage.Literals.PROPERTY_SET;
	}
	...
	public EList<Property> getPropertys() {
		if (propertys == null) {
			propertys = new EObjectResolvingEList<Property>(Property.class, this,
					commonPackage.PROPERTY_SET__PROPERTYS);
		}
		return propertys;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case commonPackage.PROPERTY_SET__PROPERTYS:
			return getPropertys();
		}
